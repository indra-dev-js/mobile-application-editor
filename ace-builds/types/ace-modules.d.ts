...
declare module "ace-builds-internal/layer/font_metrics" {
...
declare module "ace-builds-internal/apply_delta" {
    export function applyDelta(docLines: string[], delta: import("ace-builds").Ace.Delta, doNotValidate?: any): void;
}
declare module "ace-builds-internal/document" {
    /**
    ...
    export type Delta = import("ace-builds").Ace.Delta;
    export type Point = import("ace-builds").Ace.Point;
    export type IRange = import("ace-builds").Ace.IRange;
    export type NewLineMode = import("ace-builds").Ace.NewLineMode;
    import { Anchor } from "ace-builds-internal/anchor";
    import { Range } from "ace-builds-internal/range";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
        type DocumentEvents = import("ace-builds").Ace.DocumentEvents;
    }
    export interface Document extends Ace.EventEmitter<Ace.DocumentEvents> {
    }
}
declare module "ace-builds-internal/anchor" {
    /**
    ...
    export class Anchor {
         ...
         * @param {Number|import("ace-builds").Ace.Point} row The starting row position
         * @param {Number} [column] The starting column position
         **/
        constructor(doc: Document, row: number | import("ace-builds").Ace.Point, column?: number);
        /**
         * Returns an object identifying the `row` and `column` position of the current anchor.
         **/
        getPosition(): import("ace-builds").Ace.Point;
        /**
         *
    ...
    export type Document = import("ace-builds-internal/document").Document;
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
        type AnchorEvents = import("ace-builds").Ace.AnchorEvents;
        type Document = import("ace-builds").Ace.Document;
    }
...
declare module "ace-builds-internal/config" {
    const _exports: {
        defineOptions(obj: any, path: string, options: {
            [key: string]: any;
        }): import("ace-builds").Ace.AppConfig;
         ...
         * @returns {import("ace-builds").Ace.ConfigOptions[K]} - The value of the config option.
         */
        get: <K extends keyof import("ace-builds").Ace.ConfigOptions>(key: K) => import("ace-builds").Ace.ConfigOptions[K];
        set: <K extends keyof import("ace-builds").Ace.ConfigOptions>(key: K, value: import("ace-builds").Ace.ConfigOptions[K]) => void;
        all: () => import("ace-builds").Ace.ConfigOptions;
        /**
         * module loading
         */
...
declare module "ace-builds-internal/layer/lines" {
...
declare module "ace-builds-internal/layer/gutter" {
    export class Gutter {
        constructor(parentEl: HTMLElement);
        ...
        config: import("ace-builds").Ace.LayerConfig;
        oldLastRow: number;
    ...
    namespace Ace {
        ...
        type GutterEvents = import("ace-builds").Ace.GutterEvents;
    }
    export interface Gutter extends Ace.EventEmitter<Ace.GutterEvents> {
    }
}
declare module "ace-builds-internal/layer/marker" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type LayerConfig = import("ace-builds").Ace.LayerConfig;
    export class Marker {
        constructor(parentEl: HTMLElement);
        ...
        session: import("ace-builds-internal/edit_session").EditSession;
        setMarkers(markers: {
            [x: number]: import("ace-builds").Ace.MarkerLike;
        }): void;
        markers: {
            [x: number]: import("ace-builds").Ace.MarkerLike;
        };
...
declare module "ace-builds-internal/layer/text_util" {
    export function isTextToken(tokenType: any): boolean;
}
declare module "ace-builds-internal/layer/text" {
    export class Text {
        constructor(parentEl: HTMLElement);
        dom: typeof dom;
        element: HTMLDivElement;
...
declare module "ace-builds-internal/layer/cursor" {
    export class Cursor {
        constructor(parentEl: HTMLElement);
        element: HTMLDivElement;
        isVisible: boolean;
...
declare module "ace-builds-internal/scrollbar" {
...
declare module "ace-builds-internal/css/editor-css" {
...
declare module "ace-builds-internal/virtual_renderer" {
    ...
    export class VirtualRenderer {
        ...
        scrollBarV: import("ace-builds").Ace.VScrollbar;
        scrollBarH: import("ace-builds").Ace.HScrollbar;
        scrollTop: number;
        scrollLeft: number;
        cursorPos: {
            row: number;
         ...
         * @param {import("ace-builds").Ace.Annotation[]} annotations An array containing annotations
         *
         **/
        setAnnotations(annotations: import("ace-builds").Ace.Annotation[]): void;
        /**
         *
        ...
        pixelToScreenCoordinates(x: number, y: number): import("ace-builds").Ace.ScreenCoordinates;
    ...
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Point = import("ace-builds").Ace.Point;
    export type Theme = import("ace-builds").Ace.Theme;
    import { Gutter as GutterLayer } from "ace-builds-internal/layer/gutter";
    import { Marker as MarkerLayer } from "ace-builds-internal/layer/marker";
    import { Text as TextLayer } from "ace-builds-internal/layer/text";
    import { Cursor as CursorLayer } from "ace-builds-internal/layer/cursor";
    import { VScrollBar } from "ace-builds-internal/scrollbar";
    import { FontMetrics } from "ace-builds-internal/layer/font_metrics";
    import { RenderLoop } from "ace-builds-internal/renderloop";
    import { Decorator } from "ace-builds-internal/layer/decorators";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
        type VirtualRendererEvents = import("ace-builds").Ace.VirtualRendererEvents;
        type OptionsProvider<T> = import("ace-builds").Ace.OptionsProvider<T>;
        type VirtualRendererOptions = import("ace-builds").Ace.VirtualRendererOptions;
        type EditSession = import("ace-builds").Ace.EditSession;
    }
...
declare module "ace-builds-internal/selection" {
    export class Selection {
        ...
        session: EditSession;
        doc: import("ace-builds-internal/document").Document;
        cursor: Anchor;
        lead: Anchor;
        anchor: Anchor;
        /**
         ...
         * @param {import("ace-builds").Ace.IRange} range The range of text to select
         * @param {Boolean} [reverse] Indicates if the range should go backwards (`true`) or not
         **/
        setRange(range: import("ace-builds").Ace.IRange, reverse?: boolean): void;
        /**
        ...
        **/
        ...
        setSelectionRange: (range: import("ace-builds").Ace.IRange, reverse?: boolean) => void;
    }
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    ...
    namespace Ace {
        ...
        type MultiSelectionEvents = import("ace-builds").Ace.MultiSelectionEvents;
        type MultiSelectProperties = import("ace-builds").Ace.MultiSelectProperties;
    }
    export interface Selection extends Ace.EventEmitter<Ace.MultiSelectionEvents>, Ace.MultiSelectProperties {
    }
}
declare module "ace-builds-internal/clipboard" {
...
declare module "ace-builds-internal/mouse/default_handlers" {
    export type MouseHandler = import("ace-builds-internal/mouse/mouse_handler").MouseHandler;
    export type MouseEvent = import("ace-builds-internal/mouse/mouse_event").MouseEvent;
    export class DefaultHandlers {
        constructor(mouseHandler: MouseHandler);
        onMouseDown(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        mousedownEvent: import("ace-builds-internal/mouse/mouse_event").MouseEvent;
        startSelect(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, pos?: import("ace-builds").Ace.Position, waitForClickSelection?: boolean): void;
        select(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler): void;
        extendSelectionBy(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, unitName: string | number): void;
        selectByLinesEnd(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler): void;
        focusWait(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler): void;
        onDoubleClick(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onTripleClick(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onQuadClick(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onMouseWheel(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        selectEnd: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler) => void;
        selectAllEnd: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler) => void;
        selectByWordsEnd: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler) => void;
    }
}
declare module "ace-builds-internal/tooltip" {
    ...
    export class Tooltip {
        ...
        setTheme(theme: import("ace-builds").Ace.Theme): void;
...
declare module "ace-builds-internal/mouse/default_gutter_handler" {
    export function GutterHandler(this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, mouseHandler: MouseHandler): void;
...
declare module "ace-builds-internal/mouse/dragdrop_handler" {
    export type MouseHandler = import("ace-builds-internal/mouse/mouse_handler").MouseHandler;
    export function DragdropHandler(mouseHandler: MouseHandler): void;
    export class DragdropHandler {
        constructor(mouseHandler: MouseHandler);
        onDragStart: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragEnd: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragEnter: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragOver: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragLeave: (e: any) => void;
        onDrop: (this: import("ace-builds-internal/mouse/mouse_handler").MouseHandler, e: any) => any;
    }
}
declare module "ace-builds-internal/mouse/touch_handler" {
    export function addTouchListeners(el: any, editor: any): void;
}
declare module "ace-builds-internal/mouse/mouse_handler" {
    export class MouseHandler {
        ...
        destroy(): void;
        cancelDrag?: boolean;
        mousedownEvent?: import("ace-builds").Ace.MouseEvent;
        startSelect?: (pos?: import("ace-builds").Ace.Point, waitForClickSelection?: boolean) => void;
        select?: () => void;
        selectEnd?: () => void;
    }
    export type Editor = import("ace-builds-internal/editor").Editor;
    ...
    namespace Ace {
        type Range = import("ace-builds").Ace.Range;
        type MouseEvent = import("ace-builds").Ace.MouseEvent;
        type Point = import("ace-builds").Ace.Point;
    }
...
declare module "ace-builds-internal/mouse/fold_handler" {
    export class FoldHandler {
        constructor(editor: any);
    }
}
declare module "ace-builds-internal/keyboard/keybinding" {
    export type Editor = import("ace-builds-internal/editor").Editor;
    export type KeyboardHandler = import("ace-builds").Ace.KeyboardHandler;
...
declare module "ace-builds-internal/search" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
...
declare module "ace-builds-internal/commands/command_manager" {
    ...
    export type Editor = import("ace-builds-internal/editor").Editor;
    import { MultiHashHandler } from "ace-builds-internal/keyboard/hash_handler";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
...
declare module "ace-builds-internal/token_iterator" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    /**
    ...
    export class TokenIterator {
         ...
         **/
        stepBackward(): import("ace-builds").Ace.Token | null;
        /**
         * Moves iterator position to the start of next token.
         **/
        stepForward(): import("ace-builds").Ace.Token | null;
        /**
         *
         * Returns current token.
         **/
        getCurrentToken(): import("ace-builds").Ace.Token;
        /**
         *
         ...
         */
        getCurrentTokenPosition(): import("ace-builds").Ace.Point;
        /**
...
declare module "ace-builds-internal/keyboard/gutter_handler" {
    ...
    import { GutterTooltip } from "ace-builds-internal/mouse/default_gutter_handler";
}
declare module "ace-builds-internal/editor" {
    ...
    export class Editor {
         ...
         * @param {Partial<import("ace-builds").Ace.EditorOptions>} [options] The default options
         **/
        constructor(renderer: VirtualRenderer, session?: EditSession, options?: Partial<import("ace-builds").Ace.EditorOptions>);
        id: string;
        session: EditSession;
        container: HTMLElement & {
            env?: any;
         ...
         * @param {String | import("ace-builds").Ace.KeyboardHandler | null} keyboardHandler The new key handler
         **/
        setKeyboardHandler(keyboardHandler: string | import("ace-builds").Ace.KeyboardHandler | null, cb?: () => void): void;
        /**
         ...
         * @param {string | import("ace-builds").Ace.Theme} theme The path to a theme
         * @param {() => void} [cb] optional callback called when theme is loaded
         **/
        setTheme(theme: string | import("ace-builds").Ace.Theme, cb?: () => void): void;
        /**
         ...
         **/
        getSelectionStyle(): import("ace-builds").Ace.EditorOptions["selectionStyle"];
        /**
        ...
        env?: any;
        widgetManager?: import("ace-builds").Ace.LineWidgets;
        completer?: import("ace-builds").Ace.Autocomplete | import("ace-builds").Ace.InlineAutocomplete;
        completers: import("ace-builds").Ace.Completer[];
        showKeyboardShortcuts?: () => void;
        showSettingsMenu?: () => void;
        searchBox?: import("ace-builds").Ace.SearchBox;
    }
    export namespace Editor {
        export { $uid };
    }
    export type VirtualRenderer = import("ace-builds-internal/virtual_renderer").VirtualRenderer;
    export type Selection = import("ace-builds-internal/selection").Selection;
    export type Point = import("ace-builds").Ace.Point;
    export type SearchOptions = import("ace-builds").Ace.SearchOptions;
    ...
    var $uid: number;
    namespace Ace {
        type EditorMultiSelectProperties = import("ace-builds").Ace.EditorMultiSelectProperties;
        type OptionsProvider<T> = import("ace-builds").Ace.OptionsProvider<T>;
        type EditorOptions = import("ace-builds").Ace.EditorOptions;
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
        type EditorEvents = import("ace-builds").Ace.EditorEvents;
        type CodeLenseEditorExtension = import("ace-builds").Ace.CodeLenseEditorExtension;
        type ElasticTabstopsEditorExtension = import("ace-builds").Ace.ElasticTabstopsEditorExtension;
        type TextareaEditorExtension = import("ace-builds").Ace.TextareaEditorExtension;
        type PromptEditorExtension = import("ace-builds").Ace.PromptEditorExtension;
        type OptionsEditorExtension = import("ace-builds").Ace.OptionsEditorExtension;
        type EditSession = import("ace-builds").Ace.EditSession;
        type LineWidgets = import("ace-builds").Ace.LineWidgets;
        type Autocomplete = import("ace-builds").Ace.Autocomplete;
        type InlineAutocomplete = import("ace-builds").Ace.InlineAutocomplete;
...
declare module "ace-builds-internal/undomanager" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Delta = import("ace-builds").Ace.Delta;
    export type Point = import("ace-builds").Ace.Point;
    export type IRange = import("ace-builds").Ace.IRange;
    ...
    export class UndoManager {
         ...
         *
         **/
        add(delta: import("ace-builds").Ace.Delta, allowMerge: boolean, session?: EditSession): void;
        lastDeltas: any[];
        ...
        getRevision(): number;
        getDeltas(from: number, to?: number): import("ace-builds").Ace.Delta[];
...
declare module "ace-builds-internal/tokenizer" {
    /**
    ...
    export class Tokenizer {
        ...
        getLineTokens(line: string, startState: string | string[]): {
            tokens: import("ace-builds").Ace.Token[];
            state: string | string[];
        };
        reportError: (msg: any, data: any) => void;
    }
}
declare module "ace-builds-internal/autocomplete/popup" {
    /**
    ...
    export class AcePopup {
        ...
        isTopdown: boolean;
        autoSelect: boolean;
        data: import("ace-builds").Ace.Completion[];
        setData: (data: import("ace-builds").Ace.Completion[], filterText?: string) => void;
        getData: (row: number) => import("ace-builds").Ace.Completion;
        hide: () => void;
        anchor: "top" | "bottom";
        anchorPosition: import("ace-builds").Ace.Point;
        ...
        goTo: (where: import("ace-builds").Ace.AcePopupNavigation) => void;
    ...
    namespace Ace {
        type AcePopupWithEditor = import("ace-builds").Ace.AcePopupWithEditor;
        type Completion = import("ace-builds").Ace.Completion;
        type Point = import("ace-builds").Ace.Point;
        type AcePopupNavigation = import("ace-builds").Ace.AcePopupNavigation;
    }
...
declare module "ace-builds-internal/range_list" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Point = import("ace-builds").Ace.Point;
    export class RangeList {
        ...
        onChange: any;
        detach(): void;
        comparePoints: (p1: import("ace-builds-internal/range").Point, p2: import("ace-builds-internal/range").Point) => number;
    }
    import { Range } from "ace-builds-internal/range";
}
declare module "ace-builds-internal/snippets" {
    ...
    class SnippetManager {
        ...
        createTokenizer(): any;
        tokenizeTmSnippet(str: any, startState: any): (string | import("ace-builds").Ace.Token)[];
    ...
    import { Tokenizer } from "ace-builds-internal/tokenizer";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
...
declare module "ace-builds-internal/autocomplete/inline_screenreader" {
    /**
    ...
    export class AceInlineScreenReader {
         ...
         */
        constructor(editor: import("ace-builds-internal/editor").Editor);
        editor: import("ace-builds-internal/editor").Editor;
        ...
        popup: import("ace-builds-internal/autocomplete/popup").AcePopup;
        destroy(): void;
        /**
...
declare module "ace-builds-internal/autocomplete/inline" {
    export type Editor = import("ace-builds-internal/editor").Editor;
    /**
    ...
    export class AceInline {
         ...
         */
        show(editor: Editor, completion: import("ace-builds").Ace.Completion, prefix: string): boolean;
        inlineScreenReader: AceInlineScreenReader;
        isOpen(): boolean;
        hide(): boolean;
        destroy(): void;
    }
    import { AceInlineScreenReader } from "ace-builds-internal/autocomplete/inline_screenreader";
}
declare module "ace-builds-internal/autocomplete/util" {
...
declare module "ace-builds-internal/autocomplete" {
    /**
    ...
    export class CompletionProvider {
        ...
        gatherCompletions(editor: Editor, callback: import("ace-builds").Ace.CompletionCallbackFunction): boolean;
        completers: import("ace-builds").Ace.Completer[];
        /**
        ...
        detach(): void;
        completions: import("ace-builds").Ace.FilteredList;
    }
    export type Editor = import("ace-builds-internal/editor").Editor;
    export type CompletionProviderOptions = import("ace-builds").Ace.CompletionProviderOptions;
    export type CompletionOptions = import("ace-builds").Ace.CompletionOptions;
    export type Position = import("ace-builds").Ace.Position;
    export type BaseCompletion = {
         ...
         */
        value?: string;
        completer?: import("ace-builds").Ace.Completer;
    ...
    import { AcePopup } from "ace-builds-internal/autocomplete/popup";
    ...
    namespace Ace {
        type AcePopup = import("ace-builds").Ace.AcePopup;
        type FilteredList = import("ace-builds").Ace.FilteredList;
    }
...
declare module "ace-builds-internal/line_widgets" {
    export class LineWidgets {
        constructor(session: EditSession);
        session: import("ace-builds-internal/edit_session").EditSession;
        updateOnChange(delta: import("ace-builds").Ace.Delta): void;
        ...
        firstRow: number;
        lastRow: number;
        lineWidgets: import("ace-builds").Ace.LineWidget[];
    }
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Editor = import("ace-builds-internal/editor").Editor;
    export type VirtualRenderer = import("ace-builds-internal/virtual_renderer").VirtualRenderer;
    ...
    namespace Ace {
        type LineWidget = import("ace-builds").Ace.LineWidget;
        type Editor = import("ace-builds").Ace.Editor;
    }
...
declare module "ace-builds-internal/search_highlight" {
    export type Marker = import("ace-builds-internal/layer/marker").Marker;
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export class SearchHighlight {
        ...
        regExp: any;
        cache: any[];
        update(html: any, markerLayer: Marker, session: EditSession, config: Partial<import("ace-builds").Ace.LayerConfig>): void;
        MAX_RANGES: number;
    }
}
declare module "ace-builds-internal/occur" {
    export type Editor = import("ace-builds-internal/editor").Editor;
    export type Point = import("ace-builds").Ace.Point;
    export type SearchOptions = import("ace-builds").Ace.SearchOptions;
    /**
...
declare module "ace-builds-internal/edit_session/fold" {
    export class Fold extends RangeList {
        ...
        foldLine: import("ace-builds-internal/edit_session/fold_line").FoldLine;
        placeholder: any;
        range: import("ace-builds-internal/range").Range;
        start: import("ace-builds").Ace.Point;
        end: import("ace-builds").Ace.Point;
        sameRow: boolean;
        subFolds: Fold[];
    ...
    export type FoldLine = import("ace-builds-internal/edit_session/fold_line").FoldLine;
    export type Range = import("ace-builds-internal/range").Range;
    export type Point = import("ace-builds").Ace.Point;
    export type IRange = import("ace-builds").Ace.IRange;
    import { RangeList } from "ace-builds-internal/range_list";
    export interface Fold {
        collapseChildren?: number;
    }
}
declare module "ace-builds-internal/edit_session/fold_line" {
    export type Fold = import("ace-builds-internal/edit_session/fold").Fold;
    export class FoldLine {
        ...
        toString(): string;
        idxToPosition(idx: number): import("ace-builds").Ace.Point;
    }
    import { Range } from "ace-builds-internal/range";
}
declare module "ace-builds-internal/bidihandler" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    /**
    ...
    import bidiUtil = require("ace-builds-internal/lib/bidiutil");
}
declare module "ace-builds-internal/background_tokenizer" {
    /**
    ...
    export class BackgroundTokenizer {
        ...
        currentLine: number;
        tokenizer: import("ace-builds-internal/tokenizer").Tokenizer;
        /**
         ...
         **/
        getTokens(row: number): import("ace-builds").Ace.Token[];
        /**
    ...
    export type Document = import("ace-builds-internal/document").Document;
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Tokenizer = import("ace-builds-internal/tokenizer").Tokenizer;
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace-builds").Ace.EventEmitter<T>;
        type BackgroundTokenizerEvents = import("ace-builds").Ace.BackgroundTokenizerEvents;
    }
    export interface BackgroundTokenizer extends Ace.EventEmitter<Ace.BackgroundTokenizerEvents> {
    }
}
declare module "ace-builds-internal/edit_session/folding" {
    export type IFolding = import("ace-builds-internal/edit_session").EditSession & import("ace-builds").Ace.Folding;
    export type Delta = import("ace-builds").Ace.Delta;
    ...
    export class Folding {
         ...
         **/
        getFoldAt: (row: number, column: number, side?: number) => import("ace-builds").Ace.Fold;
        /**
         * Returns all folds in the given range. Note, that this will return folds
         **/
        getFoldsInRange: (range: import("ace-builds").Ace.Range | import("ace-builds").Ace.Delta) => import("ace-builds").Ace.Fold[];
        getFoldsInRangeList: (ranges: import("ace-builds").Ace.Range[] | import("ace-builds").Ace.Range) => import("ace-builds").Ace.Fold[];
        /**
         * Returns all folds in the document
         */
        getAllFolds: () => import("ace-builds").Ace.Fold[];
        /**
         ...
         */
        getFoldStringAt: (row: number, column: number, trim?: number, foldLine?: import("ace-builds").Ace.FoldLine) => string | null;
        getFoldLine: (docRow: number, startFoldLine?: import("ace-builds").Ace.FoldLine) => null | import("ace-builds").Ace.FoldLine;
        /**
         * Returns the fold which starts after or contains docRow
         */
        getNextFoldLine: (docRow: number, startFoldLine?: import("ace-builds").Ace.FoldLine) => null | import("ace-builds").Ace.FoldLine;
         ...
         */
        addFold: (placeholder: import("ace-builds").Ace.Fold | string, range?: import("ace-builds").Ace.Range) => import("ace-builds").Ace.Fold;
        addFolds: (folds: import("ace-builds").Ace.Fold[]) => void;
        removeFold: (fold: import("ace-builds").Ace.Fold) => void;
        removeFolds: (folds: import("ace-builds").Ace.Fold[]) => void;
        expandFold: (fold: import("ace-builds").Ace.Fold) => void;
        expandFolds: (folds: import("ace-builds").Ace.Fold[]) => void;
        unfold: (location?: number | null | import("ace-builds").Ace.Point | import("ace-builds").Ace.Range | import("ace-builds").Ace.Range[], expandInner?: boolean) => import("ace-builds").Ace.Fold[] | undefined;
        /**
         * Checks if a given documentRow is folded. This is true if there are some
         * folded parts such that some parts of the line is still visible.
         **/
        isRowFolded: (docRow: number, startFoldRow?: import("ace-builds").Ace.FoldLine) => boolean;
        getRowFoldEnd: (docRow: number, startFoldRow?: import("ace-builds").Ace.FoldLine) => number;
        getRowFoldStart: (docRow: number, startFoldRow?: import("ace-builds").Ace.FoldLine) => number;
        getFoldDisplayLine: (foldLine: import("ace-builds").Ace.FoldLine, endRow?: number | null, endColumn?: number | null, startRow?: number | null, startColumn?: number | null) => string;
        ...
        getCommentFoldRange: (row: number, column: number, dir?: number) => import("ace-builds").Ace.Range | undefined;
        ...
        getParentFoldRangeData: (row: number, ignoreCurrent?: boolean) => {
            range?: import("ace-builds").Ace.Range;
            firstRange?: import("ace-builds").Ace.Range;
        };
        onFoldWidgetClick: (row: number, e: any) => void;
        toggleFoldWidget: (toggleParent?: boolean) => void;
        updateFoldWidgets: (delta: import("ace-builds").Ace.Delta) => void;
        tokenizerUpdateFoldWidgets: (e: any) => void;
    }
}
declare module "ace-builds-internal/edit_session/bracket_match" {
    export type EditSession = import("ace-builds-internal/edit_session").EditSession;
    export type Point = import("ace-builds-internal/edit_session").Point;
    export function BracketMatch(): void;
    export class BracketMatch {
        findMatchingBracket: (this: import("ace-builds-internal/edit_session").EditSession, position: Point, chr?: string) => import("ace-builds").Ace.Point;
        getBracketRange: (this: import("ace-builds-internal/edit_session").EditSession, pos: Point) => null | Range;
        /**
         * Returns:
         ...
         *
         */
        getMatchingBracketRanges: (this: import("ace-builds-internal/edit_session").EditSession, pos: Point, isBackwards?: boolean) => null | Range[];
        /**
         * Returns [[Range]]'s for matching tags and tag names, if there are any
         */
        getMatchingTags: (this: import("ace-builds-internal/edit_session").EditSession, pos: Point) => {
            closeTag: Range;
            closeTagName: Range;
            openTag: Range;
            openTagName: Range;
...
declare module "ace-builds-internal/edit_session" {
    /**
    ...
    export class EditSession {
        ...
        */
        ...
        selection: Selection;
        destroyed: boolean;
        curOp: import("ace-builds").Ace.Operation | null;
        /**
         ...
         *
         **/
        getTokenAt(row: number, column: number): import("ace-builds").Ace.Token;
        /**
        ...
        */
         ...
         * @param {import("ace-builds").Ace.MarkerRenderer | "fullLine" | "screenLine" | "text" | "line"} [type] Identify the renderer type of the marker. If string provided, corresponding built-in renderer is used. Supported string types are "fullLine", "screenLine", "text" or "line". If a Function is provided, that Function is used as renderer.
         * @param {Boolean} [inFront] Set to `true` to establish a front marker
         *
         * @return {Number} The new marker id
         **/
        addMarker(range: Range, clazz: string, type?: import("ace-builds").Ace.MarkerRenderer | "fullLine" | "screenLine" | "text" | "line", inFront?: boolean): number;
        /**
         * Adds a dynamic marker to the session.
         * @param {import("ace-builds").Ace.MarkerLike} marker object with update method
         * @param {Boolean} [inFront] Set to `true` to establish a front marker
         *
         * @return {import("ace-builds").Ace.MarkerLike} The added marker
         **/
        addDynamicMarker(marker: import("ace-builds").Ace.MarkerLike, inFront?: boolean): import("ace-builds").Ace.MarkerLike;
        /**
        ...
        getMarkers(inFront?: boolean): {
            [id: number]: import("ace-builds").Ace.MarkerLike;
        };
         ...
         * @param {import("ace-builds").Ace.Annotation[]} annotations A list of annotations
         **/
        setAnnotations(annotations: import("ace-builds").Ace.Annotation[]): void;
        /**
         * Returns the annotations for the `EditSession`.
         **/
        getAnnotations(): import("ace-builds").Ace.Annotation[];
        /**
         ...
         **/
        setNewLineMode(newLineMode: import("ace-builds").Ace.NewLineMode): void;
        /**
         *
         * Returns the current new line mode.
         * @related Document.getNewLineMode
         **/
        getNewLineMode(): import("ace-builds").Ace.NewLineMode;
        /**
         ...
         **/
        getValue: () => string;
        lineWidgets: null | import("ace-builds").Ace.LineWidget[];
    ...
    export type FontMetrics = import("ace-builds-internal/layer/font_metrics").FontMetrics;
    export type FoldLine = import("ace-builds-internal/edit_session/fold_line").FoldLine;
    export type Point = import("ace-builds").Ace.Point;
    export type Delta = import("ace-builds").Ace.Delta;
    export type IRange = import("ace-builds").Ace.IRange;
    ...
    import { BidiHandler } from "ace-builds-internal/bidihandler";
    import { Range } from "ace-builds-internal/range";
    import { LineWidgets } from "ace-builds-internal/line_widgets";
    ...
    namespace Ace {
        ...
        type EditSessionEvents = import("ace-builds").Ace.EditSessionEvents;
        type OptionsProvider<T> = import("ace-builds").Ace.OptionsProvider<T>;
        type EditSessionOptions = import("ace-builds").Ace.EditSessionOptions;
        type Folding = import("ace-builds").Ace.Folding;
        type BracketMatch = import("ace-builds").Ace.BracketMatch;
        type Document = import("ace-builds").Ace.Document;
        type Point = import("ace-builds").Ace.Point;
        type Occur = import("ace-builds").Ace.Occur;
...
declare module "ace-builds-internal/range" {
    /**
    ...
    export class Range {
        ...
        **/
        ...
        id?: number;
        cursor?: import("ace-builds").Ace.Point;
        isBackwards?: boolean;
    }
...
declare module "ace-builds-internal/worker/worker_client" {
    export var WorkerClient: any;
}
declare module "ace-builds-internal/placeholder" {
    export class PlaceHolder {
        constructor(session: EditSession, length: number, pos: import("ace-builds").Ace.Point, others: any[], mainClass: string, othersClass: string);
        length: number;
        session: import("ace-builds-internal/edit_session").EditSession;
        doc: import("ace-builds-internal/document").Document;
        mainClass: string;
        ...
        pos: import("ace-builds-internal/anchor").Anchor;
        others: any[];
        /**
        ...
        updateAnchors(delta: import("ace-builds").Ace.Delta): void;
        updateMarkers(): void;
        /**
         * PlaceHolder.detach()
         *
    ...
    namespace Ace {
        ...
        type PlaceHolderEvents = import("ace-builds").Ace.PlaceHolderEvents;
    }
...
declare module "ace-builds-internal/commands/incremental_search_commands" {
...
declare module "ace-builds-internal/incremental_search" {
    /**
    ...
    import { Search } from "ace-builds-internal/search";
    import iSearchCommandModule = require("ace-builds-internal/commands/incremental_search_commands");
    import { Editor } from "ace-builds-internal/editor";
    import { Range } from "ace-builds-internal/range";
}
declare module "ace-builds-internal/split" {
    export type ISplit = import("ace-builds").Ace.EventEmitter<any> & {
        [key: string]: any;
    };
    export var Split: any;
}
declare module "ace-builds-internal/tokenizer_dev" {
    ...
    import { Tokenizer as BaseTokenizer } from "ace-builds-internal/tokenizer";
}
declare module "ace-builds-internal/unicode" {
    export const wordChars: any;
}
declare module "ace-builds-internal/keyboard/textarea" {
